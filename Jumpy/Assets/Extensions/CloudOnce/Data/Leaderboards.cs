...
namespace CloudOnce
{
    ...
    {
        private static readonly UnifiedLeaderboard s_jumpyTurtleHighScore = new UnifiedLeaderboard("JumpyTurtleHighScore",
#if !UNITY_EDITOR && (UNITY_IOS || UNITY_TVOS)
            "com.unKnown.HighScoreLeaderboard"
#elif !UNITY_EDITOR && UNITY_ANDROID && CLOUDONCE_GOOGLE
            ""
#else
            "JumpyTurtleHighScore"
#endif
            );

        public static UnifiedLeaderboard JumpyTurtleHighScore
        {
            get { return s_jumpyTurtleHighScore; }
        }
        ...
        {
            { "JumpyTurtleHighScore", s_jumpyTurtleHighScore }
        };
    }
}
